...
tmux send-keys -t $SESSION_NAME:0.0 'ssh triton; clear' Enter 
tmux send-keys -t $SESSION_NAME:0.1 'ssh ironman; clear' Enter
tmux send-keys -t $SESSION_NAME:0.2 'ssh tantalus; clear' Enter
